...
public class UserController {
  ...
  public UserResponse insert(@ModelAttribute UserRequest userRequest, Model model) {
    // Get user from DB by mybatis
    User user = new User(null, userRequest.getName(), userRequest.getEmail(), LocalDateTime.now(), null, false);
  ...
  public UserResponse update(@ModelAttribute UserRequest userRequest, Model model) {
    User user = new User(userRequest.getId(), userRequest.getName(), userRequest.getEmail(), null, LocalDateTime.now(), userRequest.isDelFlg());
    // Get user from DB by mybatis
