...
describe("index.html", () => {
  ...
  test("1: create user", async () => {
    ...
    const existsCreateUser = await page.$(
      `[data-testid='td-email']::-p-text(${newUser.email})`,
    );
  ...
  test("2: edit user", async () => {
    ...
    await page.$eval(
      'input[data-testid="edit-email"]',
      (element) => (element.value = ""),
    );
    await page.$eval(
      'input[data-testid="edit-password"]',
      (element) => (element.value = ""),
    );
    ...
    const existsEditedUser = await page.$(
      `[data-testid='td-email']::-p-text(${editedUser.email})`,
    );
  ...
  test("3: delete user", async () => {
    ...
    const existsDeletedUser = await page.$(
      `[data-testid='td-email']::-p-text(${editedUser.email})`,
    );
