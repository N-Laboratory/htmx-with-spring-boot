...
describe('index.html', () => {
  ...
  test('1: create user', async () => {
    // Go to top page
    await page.goto('http://localhost:3000/src/', {"waitUntil":"networkidle2"})

    // Input user info in the create modal
    await page.waitForSelector('[data-testid="create-btn"]');
    await page.screenshot({path: 'test/screenshot/test1-1.png', fullPage: true})
    ...
    await page.screenshot({path: 'test/screenshot/test1-2.png', fullPage: true})
    ...
    await page.screenshot({path: 'test/screenshot/test1-3.png', fullPage: true})
    const email = await page.$eval('[data-testid="email-text"]', element => element.textContent)
    const password = await page.$eval('[data-testid="password-text"]', element => element.textContent)
    ...
    await page.screenshot({path: 'test/screenshot/test1-4.png', fullPage: true})
  ...
  test('2: edit user', async () => {
    ...
    await page.screenshot({path: 'test/screenshot/test2-1.png', fullPage: true})
    ...
    await page.screenshot({path: 'test/screenshot/test2-2.png', fullPage: true})
    await page.click('[data-testid="edit-submit-btn"]')

    // Display the user information you have edited
    await page.waitForSelector('[data-testid="result-btn"]');
    await page.screenshot({path: 'test/screenshot/test2-3.png', fullPage: true})
    const email = await page.$eval('[data-testid="email-text"]', element => element.textContent)
    const password = await page.$eval('[data-testid="password-text"]', element => element.textContent)
    await page.click('[data-testid="result-btn"]')
    ...
    await page.waitForSelector('[data-testid="td-email"]');
    await page.screenshot({path: 'test/screenshot/test2-4.png', fullPage: true})
  ...
  test('3: delete user', async () => {
    ...
    await page.screenshot({path: 'test/screenshot/test3-1.png', fullPage: true})
    await page.click('[data-testid="delete-btn"]')
    await page.screenshot({path: 'test/screenshot/test3-2.png', fullPage: true})
    await page.click('[data-testid="delete-submit-btn"]')

    // Display the deleted user information
    await page.waitForSelector('[data-testid="result-btn"]');
    await page.screenshot({path: 'test/screenshot/test3-3.png', fullPage: true})
    const email = await page.$eval('[data-testid="email-text"]', element => element.textContent)
    const password = await page.$eval('[data-testid="password-text"]', element => element.textContent)
    await page.click('[data-testid="result-btn"]')
    ...
    await page.screenshot({path: 'test/screenshot/test3-4.png', fullPage: true})
